...
For **hshooter**, `cast` MUST include one premise-specific concept for every generated ordinary-enemy role: `popcorn`, `weaver`, `tank`, `turret`, and `kamikaze`. Describe their silhouettes, materials, and shared hostile-faction language; do not substitute generic walker/flyer roles.
