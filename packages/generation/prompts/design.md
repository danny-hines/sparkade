...
Exactly 16 hex colors. The pure-data gameplay sprites, tiles, procedural fighters, parallax backdrops and near-white UI text are recolored through these fixed slots, so the palette is your single biggest look-and-feel lever. Muse Image assets are created later to harmonize with this palette and design brief; they are not schema sprites. Slots:
