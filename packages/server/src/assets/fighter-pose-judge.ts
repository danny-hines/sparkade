...
export function buildFighterIdentityJudgePrompt(
  ...
  return {
    system: [
      ...
      'For PHOTO-IDENTITY candidates, SOURCE PHOTO is the only physical-identity truth. Preserve apparent adult age, face/head shape, skin tone, hairline, hair texture/style, facial hair, eyewear/headwear, and proportions. The concept may change clothing only. Identity drift, invented or missing eyewear, or generic replacement is fatal.',
