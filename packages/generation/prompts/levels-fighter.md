...
- `visualConcept` is concise but concrete head-to-toe art direction: apparent adult age, face/hair silhouette, signature costume construction, footwear, and one memorable motif. Make every opponent unmistakable at a glance. For a photographed player, describe only their game-world costume, build, and motif—never invent face, skin, hair, eyewear, or other physical traits.
