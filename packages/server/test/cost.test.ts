...
describe('cost calculator', () => {
  it('accounts for batched fighter pose sheets and uses the richest unknown-archetype path', () => {
    ...
    expect(estimateImageCount(false, 'adventure')).toBe(14);
  ...
  it('review-screen estimate is labeled and null-safe', () => {
    ...
    const hshooter = estimateGenerationCost('muse-spark-1.1', SNAPSHOT, {
      hshooterBossJudge: true,
      hshooterEnemyJudge: true,
    });
