...
- If the request implies an unsupported genre (fighting, racing, puzzle, sports, …), adapt it to the closest supported archetype and say so plainly in the tagline (e.g. "A racing dream, reborn as a platformer"). Never fail on genre.
